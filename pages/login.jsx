...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative overflow-x-hidden overflow-y-auto text-gray-100 font-sans selection:bg-pulsai-blue/30 selection:text-white">
      
      {/* Background Gradients */}
      <div className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] bg-pulsai-blue/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] bg-pulsai-green/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="py-6 text-center text-xs text-gray-600 z-10 shrink-0">
